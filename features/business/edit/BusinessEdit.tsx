...
import { useBusinessEdit } from "./hooks/useBusinessEdit";
import { BusinessSocialLinksManager } from "../create/components/BusinessSocialLinksManager";

interface BusinessEditProps {
  businessId: string;
}

export const BusinessEdit = ({ businessId }: BusinessEditProps) => {
  const {
    form,
    socialLinks,
    slugValue,
