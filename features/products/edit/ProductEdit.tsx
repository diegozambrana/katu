...
import { ProductImagesManager } from "../create/components/ProductImagesManager";
import { ProductPriceTiersManager } from "../create/components/ProductPriceTiersManager";
...
export const ProductEdit = ({ productId }: ProductEditProps) => {
  ...
  return (
    <MainContainer title="Editar Producto">
      <div className="mb-6">
